...
*/
define(["jquery", "qlik", "./scripts/d3.min", "./scripts/lasso_adj", "text!./styles/bi-irregular-2dim-heatmap.css"],
                ...
                var viz2DimHeatmap = function (_this, app, id, data, qDimensionType, qDimSort, width, height, id, colorpalette, dimensionLabels,
                    ...
                    if (showLegend) {
                        ...
                        legend.append("text")
                            ...
                            .text(function (d) {
                                return (gridSize < smallSize ? "" : "≥ ") + (measurePercentage ? formatLegend(Math.round(d * 1000) / 10) + "%" : formatLegend(Math.round(d)));
                            })
                            .attr("x", function (d, i) {
                                return legendElementWidth * i;
                            })
